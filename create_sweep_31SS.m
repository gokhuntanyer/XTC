...
%
%
%                   OK  T=10 case. This is comparison between T = 2 and 10 seconds.
%                       Reading both: rawdataT_10_pn_10_48K4.wav and
%...31              ..  Data: rawdataT_2_pn_10.wav
...
%4
    ...
    %V=axis; axis([3.85 4.3 -80 80]);
    %V=axis; axis([t0 t0+dt -80 80]); %This is for T=2;
     V=axis; axis([t0 t0+dt -3500 3500]); %This is for T=10;
    xlabel('Time (seconds)');
    
    subplot(212),
    plot(timeS,A, 'b');grid on;axis('tight');
    %V=axis; axis([3.85 4.3 -800 800]);
