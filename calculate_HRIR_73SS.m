...
%2  PLOT CORRELATION    
    ...
    axis('tight'); 
    V=axis; axis([0 Fs/2 V(3) V(4)/2]); grid on;
    title('Phase of (red) S and (blue:A-100) (Cable transmission)');
    xlabel('Frequency (Hertz)');
    ...
    axis('tight'); 
    V=axis; axis([0 Fs/2 V(3) V(4)/2]); grid on;
    title('Phase of (red) S and (blue: A-100)(Short distance loudspeaker)');        
    xlabel('Frequency (Hertz)');
    ...
    axis('tight'); 
    V=axis; axis([0 Fs/2 V(3)/2 V(4)]); grid on;
    title('Phase difference of two S (red) S (blue) measurements');        
    xlabel('Frequency (Hertz)');
